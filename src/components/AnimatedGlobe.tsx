    ...
    <div className="relative w-full">
      <div ref={canvasRef} className="globe-container animate-float">
        ...
        <div className="absolute inset-4 rounded-full overflow-hidden">
          <div className="absolute top-[25%] left-[25%] w-[15%] h-[15%] bg-blue-200 rounded-full"></div>{" "}
          {/* North America */}
          <div className="absolute top-[40%] left-[35%] w-[10%] h-[15%] bg-blue-200 rounded-full"></div>{" "}
          {/* South America */}
          <div className="absolute top-[30%] left-[50%] w-[12%] h-[10%] bg-blue-200 rounded-full"></div>{" "}
          {/* Europe */}
          <div className="absolute top-[35%] left-[60%] w-[18%] h-[17%] bg-blue-200 rounded-full"></div>{" "}
          {/* Asia */}
          <div className="absolute top-[45%] left-[55%] w-[15%] h-[12%] bg-blue-200 rounded-full"></div>{" "}
          {/* Africa */}
          <div className="absolute top-[60%] left-[70%] w-[12%] h-[8%] bg-blue-200 rounded-full"></div>{" "}
          {/* Australia */}
        </div>
